...
/* Dynamic, header-free HIP discovery.  This bridge owns no tensor semantics.
   Protocol: 0 missing library, 1 missing query symbol, 2 query error,
   3 zero devices, 256+n for n > 0 devices. */
