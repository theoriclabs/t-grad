...
| 4 | Truncate `/tmp/tgrad_rangeify_trace.jsonl` to empty | Criterion 2 audit's `rangeify_trace_rows == 0` AND `nontrivial < 16` → `verdict: fail`; static_check `rangeify_traces_present: false` | ✓ 2026-05-14 |
